...
public class PropertyTaxWatcher implements EntryPoint
{
	...
	public static final PropertyTaxServiceAsync propertyTaxService = GWT
	...
	public static void initializePropertyTaxes() {
	...
	private static void addPropertyTax(final PropertyTax propertyTax) {
		propertyTaxService.addPropertyTax(propertyTax,
				new AsyncCallback<Void>() {
					public void onFailure(Throwable error) {
						System.out.println("Fail to initialize Property Tax!");
					}
