...
public class PropertyTaxWatcher implements EntryPoint
{
	...
	public void runVisualizations()
	{
		VisualizationUtils.loadVisualizationApi(new Runnable()
		{
			public void run()
			{
				...
				mainPanel.add(new Label("Search Result."));
				mainPanel.add(resultTabPanel);
				resultTabPanel.setWidth("800");
				resultTabPanel.setHeight("600");
				resultTabPanel.setVisible(hasSearch);
				resultTabPanel.add(createDataTableWidget(searchView), "Table");
	...
	private Widget createDataTableWidget(AbstractDataTable dataTable)
	{
		...
		formatter.format((DataTable) dataTable, 1);
