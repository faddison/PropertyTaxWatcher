...
public class PropertyTax  implements Serializable
{
	...
	/**
	 * @param legal_type the legal_type to set
	 */
	...
	/**
	 * @param land_coordinate the land_coordinate to set
	 */
	...
	/**
	 * @param district_lot the district_lot to set
	 */
	...
	/**
	 * @param from_civic_number the from_civic_number to set
	 */
	...
	/**
	 * @param to_civic_number the to_civic_number to set
	 */
	...
	/**
	 * @param street_prefix_direction the street_prefix_direction to set
	 */
	...
	/**
	 * @param property_postal_code the property_postal_code to set
	 */
	...
	/**
	 * @param record_status_code the record_status_code to set
	 */
	...
	/**
	 * @param narrative_legal_line1 the narrative_legal_line1 to set
	 */
	...
	/**
	 * @param narrative_legal_line2 the narrative_legal_line2 to set
	 */
	...
	/**
	 * @param narrative_legal_line3 the narrative_legal_line3 to set
	 */
	...
	/**
	 * @param narrative_legal_line4 the narrative_legal_line4 to set
	 */
	...
	/**
	 * @param narrative_legal_line5 the narrative_legal_line5 to set
	 */
	...
	/**
	 * @param current_land_value the current_land_value to set
	 */
	...
	/**
	 * @param current_improvement_value the current_improvement_value to set
	 */
	...
	/**
	 * @param assessment_year the assessment_year to set
	 */
	...
	/**
	 * @param previous_land_value the previous_land_value to set
	 */
	...
	/**
	 * @param previous_improvement_value the previous_improvement_value to set
	 */
	...
	/**
	 * @param year_built the year_built to set
	 */
	...
	/**
	 * @param big_improvement_year the big_improvement_year to set
	 */
