...
import ca.ubc.cs310.golddiggers.propertytaxwatcher.client.NotLoggedInException;
...
PropertyTaxService {
  ...
  private static final Logger LOG = Logger.getLogger(PropertyTaxServiceImpl.class.getName());
  private static final PersistenceManagerFactory PMF =
      JDOHelper.getPersistenceManagerFactory("transactions-optional");

  public void addPropertyTax(PropertyTax propertyTax) throws NotLoggedInException {
    checkLoggedIn();
  ...
  public void removePropertyTax(String pid) throws NotLoggedInException {
    ...
    try {
      ...
      List<PropertyTax> propertyTaxes = (List<PropertyTax>) q.execute(getUser());
      ...
      if (deleteCount != 1) {
        LOG.log(Level.WARNING, "removePropertyTax deleted "+deleteCount+" PropertyTaxs");
      }
    } finally {
      pm.close();
    }
  ...
  public ArrayList<PropertyTax> getPropertyTaxes() throws NotLoggedInException {
    checkLoggedIn();
    PersistenceManager pm = getPersistenceManager();
